...
EddyPro&reg; is a powerful open source software application for processing eddy covariance data. It computes fluxes of water vapor (evapotranspiration), carbon
dioxide, and other trace gases, and energy with the Eddy Covariance method.

[LI-COR Biosciences](http://www.licor.com) has not published upstream EddyPro updates for several years. This repository is an actively maintained fork of EddyPro 6.2.2 that continues development while gratefully acknowledging LI-COR, ECO2S, and the original EddyPro authors for creating and releasing EddyPro.EddyPro originates from [ECO<sub>2</sub>S](http://gaia.agraria.unitus.it/eco2s), the Eddy COvariance COmmunity Software project, which was developed as part of the Infrastructure for Measurement of the European Carbon Cycle (IMECC-EU) research project. We gratefully acknowledge the [IMECC](http://imecc.ipsl.jussieu.fr/index.html) consortium, the ECO<sub>2</sub>S development team, the [University of Tuscia](https://www.unitus.it) (Italy) and scientists around the world who assisted with development and testing of the original version of this software.
...
[GNU General Public License (GPL) v3.0](https://github.com/LI-COR/eddypro-gui/blob/master/LICENSE).
