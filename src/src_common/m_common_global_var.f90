...
module m_common_global_var
    ...
    data (MW(mmm), mmm = histGas1, histGas4) / 44.01e-3, 18.02e-3, 16.04e-3, 44.01e-3/
...
!    'PPBD','NMOLMOL-1','NMOL/MOL','NMOLMOL^-1'/ !> units that need change
    ...
    data ANTags(801)%Label / 'col_84_flag_threshold' / &
         ...
         ANTags(930)%Label / 'col_101_min_value' / &
         ANTags(931)%Label / 'col_101_max_value' / &
         ANTags(932)%Label / 'col_101_a_value' / &
         ANTags(933)%Label / 'col_101_b_value' / &
         ANTags(934)%Label / 'col_101_nom_timelag' / &
         ANTags(935)%Label / 'col_101_min_timelag' / &
         ANTags(936)%Label / 'col_101_max_timelag' / &
         ANTags(937)%Label / 'col_101_flag_threshold' / &
         ANTags(938)%Label / 'col_102_min_value' / &
         ANTags(939)%Label / 'col_102_max_value' / &
         ANTags(940)%Label / 'col_102_a_value' / &
         ANTags(941)%Label / 'col_102_b_value' / &
         ANTags(942)%Label / 'col_102_nom_timelag' / &
         ANTags(943)%Label / 'col_102_min_timelag' / &
         ANTags(944)%Label / 'col_102_max_timelag' / &
         ANTags(945)%Label / 'col_102_flag_threshold' / &
         ANTags(946)%Label / 'col_103_min_value' / &
         ANTags(947)%Label / 'col_103_max_value' / &
         ANTags(948)%Label / 'col_103_a_value' / &
         ANTags(949)%Label / 'col_103_b_value' / &
         ANTags(950)%Label / 'col_103_nom_timelag' / &
         ANTags(951)%Label / 'col_103_min_timelag' / &
         ANTags(952)%Label / 'col_103_max_timelag' / &
         ANTags(953)%Label / 'col_103_flag_threshold' / &
         ANTags(954)%Label / 'col_104_min_value' / &
         ANTags(955)%Label / 'col_104_max_value' / &
         ANTags(956)%Label / 'col_104_a_value' / &
         ANTags(957)%Label / 'col_104_b_value' / &
         ANTags(958)%Label / 'col_104_nom_timelag' / &
         ANTags(959)%Label / 'col_104_min_timelag' / &
         ANTags(960)%Label / 'col_104_max_timelag' / &
         ANTags(961)%Label / 'col_104_flag_threshold' / &
         ANTags(962)%Label / 'col_105_min_value' / &
         ANTags(963)%Label / 'col_105_max_value' / &
         ANTags(964)%Label / 'col_105_a_value' / &
         ANTags(965)%Label / 'col_105_b_value' / &
         ANTags(966)%Label / 'col_105_nom_timelag' / &
         ANTags(967)%Label / 'col_105_min_timelag' / &
         ANTags(968)%Label / 'col_105_max_timelag' / &
         ANTags(969)%Label / 'col_105_flag_threshold' / &
         ANTags(970)%Label / 'col_106_min_value' / &
         ANTags(971)%Label / 'col_106_max_value' / &
         ANTags(972)%Label / 'col_106_a_value' / &
         ANTags(973)%Label / 'col_106_b_value' / &
         ANTags(974)%Label / 'col_106_nom_timelag' / &
         ANTags(975)%Label / 'col_106_min_timelag' / &
         ANTags(976)%Label / 'col_106_max_timelag' / &
         ANTags(977)%Label / 'col_106_flag_threshold' / &
         ANTags(978)%Label / 'col_107_min_value' / &
         ANTags(979)%Label / 'col_107_max_value' / &
         ANTags(980)%Label / 'col_107_a_value' / &
         ANTags(981)%Label / 'col_107_b_value' / &
         ANTags(982)%Label / 'col_107_nom_timelag' / &
         ANTags(983)%Label / 'col_107_min_timelag' / &
         ANTags(984)%Label / 'col_107_max_timelag' / &
         ANTags(985)%Label / 'col_107_flag_threshold' / &
         ANTags(986)%Label / 'col_108_min_value' / &
         ANTags(987)%Label / 'col_108_max_value' / &
         ANTags(988)%Label / 'col_108_a_value' / &
         ANTags(989)%Label / 'col_108_b_value' / &
         ANTags(990)%Label / 'col_108_nom_timelag' / &
         ANTags(991)%Label / 'col_108_min_timelag' / &
         ANTags(992)%Label / 'col_108_max_timelag' / &
         ANTags(993)%Label / 'col_108_flag_threshold' / &
         ANTags(994)%Label / 'col_109_min_value' / &
         ANTags(995)%Label / 'col_109_max_value' / &
         ANTags(996)%Label / 'col_109_a_value' / &
         ANTags(997)%Label / 'col_109_b_value' / &
         ANTags(998)%Label / 'col_109_nom_timelag' / &
         ANTags(999)%Label / 'col_109_min_timelag' / &
         ANTags(1000)%Label / 'col_109_max_timelag' /
    data ANTags(1001)%Label / 'col_109_flag_threshold' / &
         ANTags(1002)%Label / 'col_110_min_value' / &
         ANTags(1003)%Label / 'col_110_max_value' / &
         ANTags(1004)%Label / 'col_110_a_value' / &
         ANTags(1005)%Label / 'col_110_b_value' / &
         ANTags(1006)%Label / 'col_110_nom_timelag' / &
         ANTags(1007)%Label / 'col_110_min_timelag' / &
         ANTags(1008)%Label / 'col_110_max_timelag' / &
         ANTags(1009)%Label / 'col_110_flag_threshold' / &
         ANTags(1010)%Label / 'col_111_min_value' / &
         ANTags(1011)%Label / 'col_111_max_value' / &
         ANTags(1012)%Label / 'col_111_a_value' / &
         ANTags(1013)%Label / 'col_111_b_value' / &
         ANTags(1014)%Label / 'col_111_nom_timelag' / &
         ANTags(1015)%Label / 'col_111_min_timelag' / &
         ANTags(1016)%Label / 'col_111_max_timelag' / &
         ANTags(1017)%Label / 'col_111_flag_threshold' / &
         ANTags(1018)%Label / 'col_112_min_value' / &
         ANTags(1019)%Label / 'col_112_max_value' / &
         ANTags(1020)%Label / 'col_112_a_value' / &
         ANTags(1021)%Label / 'col_112_b_value' / &
         ANTags(1022)%Label / 'col_112_nom_timelag' / &
         ANTags(1023)%Label / 'col_112_min_timelag' / &
         ANTags(1024)%Label / 'col_112_max_timelag' / &
         ANTags(1025)%Label / 'col_112_flag_threshold' / &
         ANTags(1026)%Label / 'col_113_min_value' / &
         ANTags(1027)%Label / 'col_113_max_value' / &
         ANTags(1028)%Label / 'col_113_a_value' / &
         ANTags(1029)%Label / 'col_113_b_value' / &
         ANTags(1030)%Label / 'col_113_nom_timelag' / &
         ANTags(1031)%Label / 'col_113_min_timelag' / &
         ANTags(1032)%Label / 'col_113_max_timelag' / &
         ANTags(1033)%Label / 'col_113_flag_threshold' / &
         ANTags(1034)%Label / 'col_114_min_value' / &
         ANTags(1035)%Label / 'col_114_max_value' / &
         ANTags(1036)%Label / 'col_114_a_value' / &
         ANTags(1037)%Label / 'col_114_b_value' / &
         ANTags(1038)%Label / 'col_114_nom_timelag' / &
         ANTags(1039)%Label / 'col_114_min_timelag' / &
         ANTags(1040)%Label / 'col_114_max_timelag' / &
         ANTags(1041)%Label / 'col_114_flag_threshold' / &
         ANTags(1042)%Label / 'col_115_min_value' / &
         ANTags(1043)%Label / 'col_115_max_value' / &
         ANTags(1044)%Label / 'col_115_a_value' / &
         ANTags(1045)%Label / 'col_115_b_value' / &
         ANTags(1046)%Label / 'col_115_nom_timelag' / &
         ANTags(1047)%Label / 'col_115_min_timelag' / &
         ANTags(1048)%Label / 'col_115_max_timelag' / &
         ANTags(1049)%Label / 'col_115_flag_threshold' / &
         ANTags(1050)%Label / 'col_116_min_value' / &
         ANTags(1051)%Label / 'col_116_max_value' / &
         ANTags(1052)%Label / 'col_116_a_value' / &
         ANTags(1053)%Label / 'col_116_b_value' / &
         ANTags(1054)%Label / 'col_116_nom_timelag' / &
         ANTags(1055)%Label / 'col_116_min_timelag' / &
         ANTags(1056)%Label / 'col_116_max_timelag' / &
         ANTags(1057)%Label / 'col_116_flag_threshold' / &
         ANTags(1058)%Label / 'col_117_min_value' / &
         ANTags(1059)%Label / 'col_117_max_value' / &
         ANTags(1060)%Label / 'col_117_a_value' / &
         ANTags(1061)%Label / 'col_117_b_value' / &
         ANTags(1062)%Label / 'col_117_nom_timelag' / &
         ANTags(1063)%Label / 'col_117_min_timelag' / &
         ANTags(1064)%Label / 'col_117_max_timelag' / &
         ANTags(1065)%Label / 'col_117_flag_threshold' / &
         ANTags(1066)%Label / 'col_118_min_value' / &
         ANTags(1067)%Label / 'col_118_max_value' / &
         ANTags(1068)%Label / 'col_118_a_value' / &
         ANTags(1069)%Label / 'col_118_b_value' / &
         ANTags(1070)%Label / 'col_118_nom_timelag' / &
         ANTags(1071)%Label / 'col_118_min_timelag' / &
         ANTags(1072)%Label / 'col_118_max_timelag' / &
         ANTags(1073)%Label / 'col_118_flag_threshold' / &
         ANTags(1074)%Label / 'col_119_min_value' / &
         ANTags(1075)%Label / 'col_119_max_value' / &
         ANTags(1076)%Label / 'col_119_a_value' / &
         ANTags(1077)%Label / 'col_119_b_value' / &
         ANTags(1078)%Label / 'col_119_nom_timelag' / &
         ANTags(1079)%Label / 'col_119_min_timelag' / &
         ANTags(1080)%Label / 'col_119_max_timelag' / &
         ANTags(1081)%Label / 'col_119_flag_threshold' / &
         ANTags(1082)%Label / 'col_120_min_value' / &
         ANTags(1083)%Label / 'col_120_max_value' / &
         ANTags(1084)%Label / 'col_120_a_value' / &
         ANTags(1085)%Label / 'col_120_b_value' / &
         ANTags(1086)%Label / 'col_120_nom_timelag' / &
         ANTags(1087)%Label / 'col_120_min_timelag' / &
         ANTags(1088)%Label / 'col_120_max_timelag' / &
         ANTags(1089)%Label / 'col_120_flag_threshold' / &
         ANTags(1090)%Label / 'col_121_min_value' / &
         ANTags(1091)%Label / 'col_121_max_value' / &
         ANTags(1092)%Label / 'col_121_a_value' / &
         ANTags(1093)%Label / 'col_121_b_value' / &
         ANTags(1094)%Label / 'col_121_nom_timelag' / &
         ANTags(1095)%Label / 'col_121_min_timelag' / &
         ANTags(1096)%Label / 'col_121_max_timelag' / &
         ANTags(1097)%Label / 'col_121_flag_threshold' / &
         ANTags(1098)%Label / 'col_122_min_value' / &
         ANTags(1099)%Label / 'col_122_max_value' / &
         ANTags(1100)%Label / 'col_122_a_value' / &
         ANTags(1101)%Label / 'col_122_b_value' / &
         ANTags(1102)%Label / 'col_122_nom_timelag' / &
         ANTags(1103)%Label / 'col_122_min_timelag' / &
         ANTags(1104)%Label / 'col_122_max_timelag' / &
         ANTags(1105)%Label / 'col_122_flag_threshold' / &
         ANTags(1106)%Label / 'col_123_min_value' / &
         ANTags(1107)%Label / 'col_123_max_value' / &
         ANTags(1108)%Label / 'col_123_a_value' / &
         ANTags(1109)%Label / 'col_123_b_value' / &
         ANTags(1110)%Label / 'col_123_nom_timelag' / &
         ANTags(1111)%Label / 'col_123_min_timelag' / &
         ANTags(1112)%Label / 'col_123_max_timelag' / &
         ANTags(1113)%Label / 'col_123_flag_threshold' / &
         ANTags(1114)%Label / 'col_124_min_value' / &
         ANTags(1115)%Label / 'col_124_max_value' / &
         ANTags(1116)%Label / 'col_124_a_value' / &
         ANTags(1117)%Label / 'col_124_b_value' / &
         ANTags(1118)%Label / 'col_124_nom_timelag' / &
         ANTags(1119)%Label / 'col_124_min_timelag' / &
         ANTags(1120)%Label / 'col_124_max_timelag' / &
         ANTags(1121)%Label / 'col_124_flag_threshold' / &
         ANTags(1122)%Label / 'col_125_min_value' / &
         ANTags(1123)%Label / 'col_125_max_value' / &
         ANTags(1124)%Label / 'col_125_a_value' / &
         ANTags(1125)%Label / 'col_125_b_value' / &
         ANTags(1126)%Label / 'col_125_nom_timelag' / &
         ANTags(1127)%Label / 'col_125_min_timelag' / &
         ANTags(1128)%Label / 'col_125_max_timelag' / &
         ANTags(1129)%Label / 'col_125_flag_threshold' / &
         ANTags(1130)%Label / 'col_126_min_value' / &
         ANTags(1131)%Label / 'col_126_max_value' / &
         ANTags(1132)%Label / 'col_126_a_value' / &
         ANTags(1133)%Label / 'col_126_b_value' / &
         ANTags(1134)%Label / 'col_126_nom_timelag' / &
         ANTags(1135)%Label / 'col_126_min_timelag' / &
         ANTags(1136)%Label / 'col_126_max_timelag' / &
         ANTags(1137)%Label / 'col_126_flag_threshold' / &
         ANTags(1138)%Label / 'col_127_min_value' / &
         ANTags(1139)%Label / 'col_127_max_value' / &
         ANTags(1140)%Label / 'col_127_a_value' / &
         ANTags(1141)%Label / 'col_127_b_value' / &
         ANTags(1142)%Label / 'col_127_nom_timelag' / &
         ANTags(1143)%Label / 'col_127_min_timelag' / &
         ANTags(1144)%Label / 'col_127_max_timelag' / &
         ANTags(1145)%Label / 'col_127_flag_threshold' / &
         ANTags(1146)%Label / 'col_128_min_value' / &
         ANTags(1147)%Label / 'col_128_max_value' / &
         ANTags(1148)%Label / 'col_128_a_value' / &
         ANTags(1149)%Label / 'col_128_b_value' / &
         ANTags(1150)%Label / 'col_128_nom_timelag' / &
         ANTags(1151)%Label / 'col_128_min_timelag' / &
         ANTags(1152)%Label / 'col_128_max_timelag' / &
         ANTags(1153)%Label / 'col_128_flag_threshold' / &
         ANTags(1154)%Label / 'col_129_min_value' / &
         ANTags(1155)%Label / 'col_129_max_value' / &
         ANTags(1156)%Label / 'col_129_a_value' / &
         ANTags(1157)%Label / 'col_129_b_value' / &
         ANTags(1158)%Label / 'col_129_nom_timelag' / &
         ANTags(1159)%Label / 'col_129_min_timelag' / &
         ANTags(1160)%Label / 'col_129_max_timelag' / &
         ANTags(1161)%Label / 'col_129_flag_threshold' / &
         ANTags(1162)%Label / 'col_130_min_value' / &
         ANTags(1163)%Label / 'col_130_max_value' / &
         ANTags(1164)%Label / 'col_130_a_value' / &
         ANTags(1165)%Label / 'col_130_b_value' / &
         ANTags(1166)%Label / 'col_130_nom_timelag' / &
         ANTags(1167)%Label / 'col_130_min_timelag' / &
         ANTags(1168)%Label / 'col_130_max_timelag' / &
         ANTags(1169)%Label / 'col_130_flag_threshold' / &
         ANTags(1170)%Label / 'col_131_min_value' / &
         ANTags(1171)%Label / 'col_131_max_value' / &
         ANTags(1172)%Label / 'col_131_a_value' / &
         ANTags(1173)%Label / 'col_131_b_value' / &
         ANTags(1174)%Label / 'col_131_nom_timelag' / &
         ANTags(1175)%Label / 'col_131_min_timelag' / &
         ANTags(1176)%Label / 'col_131_max_timelag' / &
         ANTags(1177)%Label / 'col_131_flag_threshold' / &
         ANTags(1178)%Label / 'col_132_min_value' / &
         ANTags(1179)%Label / 'col_132_max_value' / &
         ANTags(1180)%Label / 'col_132_a_value' / &
         ANTags(1181)%Label / 'col_132_b_value' / &
         ANTags(1182)%Label / 'col_132_nom_timelag' / &
         ANTags(1183)%Label / 'col_132_min_timelag' / &
         ANTags(1184)%Label / 'col_132_max_timelag' / &
         ANTags(1185)%Label / 'col_132_flag_threshold' / &
         ANTags(1186)%Label / 'col_133_min_value' / &
         ANTags(1187)%Label / 'col_133_max_value' / &
         ANTags(1188)%Label / 'col_133_a_value' / &
         ANTags(1189)%Label / 'col_133_b_value' / &
         ANTags(1190)%Label / 'col_133_nom_timelag' / &
         ANTags(1191)%Label / 'col_133_min_timelag' / &
         ANTags(1192)%Label / 'col_133_max_timelag' / &
         ANTags(1193)%Label / 'col_133_flag_threshold' / &
         ANTags(1194)%Label / 'col_134_min_value' / &
         ANTags(1195)%Label / 'col_134_max_value' / &
         ANTags(1196)%Label / 'col_134_a_value' / &
         ANTags(1197)%Label / 'col_134_b_value' / &
         ANTags(1198)%Label / 'col_134_nom_timelag' / &
         ANTags(1199)%Label / 'col_134_min_timelag' / &
         ANTags(1200)%Label / 'col_134_max_timelag' /
    data ANTags(1201)%Label / 'col_134_flag_threshold' / &
         ANTags(1202)%Label / 'col_135_min_value' / &
         ANTags(1203)%Label / 'col_135_max_value' / &
         ANTags(1204)%Label / 'col_135_a_value' / &
         ANTags(1205)%Label / 'col_135_b_value' / &
         ANTags(1206)%Label / 'col_135_nom_timelag' / &
         ANTags(1207)%Label / 'col_135_min_timelag' / &
         ANTags(1208)%Label / 'col_135_max_timelag' / &
         ANTags(1209)%Label / 'col_135_flag_threshold' / &
         ANTags(1210)%Label / 'col_136_min_value' / &
         ANTags(1211)%Label / 'col_136_max_value' / &
         ANTags(1212)%Label / 'col_136_a_value' / &
         ANTags(1213)%Label / 'col_136_b_value' / &
         ANTags(1214)%Label / 'col_136_nom_timelag' / &
         ANTags(1215)%Label / 'col_136_min_timelag' / &
         ANTags(1216)%Label / 'col_136_max_timelag' / &
         ANTags(1217)%Label / 'col_136_flag_threshold' / &
         ANTags(1218)%Label / 'col_137_min_value' / &
         ANTags(1219)%Label / 'col_137_max_value' / &
         ANTags(1220)%Label / 'col_137_a_value' / &
         ANTags(1221)%Label / 'col_137_b_value' / &
         ANTags(1222)%Label / 'col_137_nom_timelag' / &
         ANTags(1223)%Label / 'col_137_min_timelag' / &
         ANTags(1224)%Label / 'col_137_max_timelag' / &
         ANTags(1225)%Label / 'col_137_flag_threshold' / &
         ANTags(1226)%Label / 'col_138_min_value' / &
         ANTags(1227)%Label / 'col_138_max_value' / &
         ANTags(1228)%Label / 'col_138_a_value' / &
         ANTags(1229)%Label / 'col_138_b_value' / &
         ANTags(1230)%Label / 'col_138_nom_timelag' / &
         ANTags(1231)%Label / 'col_138_min_timelag' / &
         ANTags(1232)%Label / 'col_138_max_timelag' / &
         ANTags(1233)%Label / 'col_138_flag_threshold' / &
         ANTags(1234)%Label / 'col_139_min_value' / &
         ANTags(1235)%Label / 'col_139_max_value' / &
         ANTags(1236)%Label / 'col_139_a_value' / &
         ANTags(1237)%Label / 'col_139_b_value' / &
         ANTags(1238)%Label / 'col_139_nom_timelag' / &
         ANTags(1239)%Label / 'col_139_min_timelag' / &
         ANTags(1240)%Label / 'col_139_max_timelag' / &
         ANTags(1241)%Label / 'col_139_flag_threshold' / &
         ANTags(1242)%Label / 'col_140_min_value' / &
         ANTags(1243)%Label / 'col_140_max_value' / &
         ANTags(1244)%Label / 'col_140_a_value' / &
         ANTags(1245)%Label / 'col_140_b_value' / &
         ANTags(1246)%Label / 'col_140_nom_timelag' / &
         ANTags(1247)%Label / 'col_140_min_timelag' / &
         ANTags(1248)%Label / 'col_140_max_timelag' / &
         ANTags(1249)%Label / 'col_140_flag_threshold' / &
         ANTags(1250)%Label / 'col_141_min_value' / &
         ANTags(1251)%Label / 'col_141_max_value' / &
         ANTags(1252)%Label / 'col_141_a_value' / &
         ANTags(1253)%Label / 'col_141_b_value' / &
         ANTags(1254)%Label / 'col_141_nom_timelag' / &
         ANTags(1255)%Label / 'col_141_min_timelag' / &
         ANTags(1256)%Label / 'col_141_max_timelag' / &
         ANTags(1257)%Label / 'col_141_flag_threshold' / &
         ANTags(1258)%Label / 'col_142_min_value' / &
         ANTags(1259)%Label / 'col_142_max_value' / &
         ANTags(1260)%Label / 'col_142_a_value' / &
         ANTags(1261)%Label / 'col_142_b_value' / &
         ANTags(1262)%Label / 'col_142_nom_timelag' / &
         ANTags(1263)%Label / 'col_142_min_timelag' / &
         ANTags(1264)%Label / 'col_142_max_timelag' / &
         ANTags(1265)%Label / 'col_142_flag_threshold' / &
         ANTags(1266)%Label / 'col_143_min_value' / &
         ANTags(1267)%Label / 'col_143_max_value' / &
         ANTags(1268)%Label / 'col_143_a_value' / &
         ANTags(1269)%Label / 'col_143_b_value' / &
         ANTags(1270)%Label / 'col_143_nom_timelag' / &
         ANTags(1271)%Label / 'col_143_min_timelag' / &
         ANTags(1272)%Label / 'col_143_max_timelag' / &
         ANTags(1273)%Label / 'col_143_flag_threshold' / &
         ANTags(1274)%Label / 'col_144_min_value' / &
         ANTags(1275)%Label / 'col_144_max_value' / &
         ANTags(1276)%Label / 'col_144_a_value' / &
         ANTags(1277)%Label / 'col_144_b_value' / &
         ANTags(1278)%Label / 'col_144_nom_timelag' / &
         ANTags(1279)%Label / 'col_144_min_timelag' / &
         ANTags(1280)%Label / 'col_144_max_timelag' / &
         ANTags(1281)%Label / 'col_144_flag_threshold' / &
         ANTags(1282)%Label / 'col_145_min_value' / &
         ANTags(1283)%Label / 'col_145_max_value' / &
         ANTags(1284)%Label / 'col_145_a_value' / &
         ANTags(1285)%Label / 'col_145_b_value' / &
         ANTags(1286)%Label / 'col_145_nom_timelag' / &
         ANTags(1287)%Label / 'col_145_min_timelag' / &
         ANTags(1288)%Label / 'col_145_max_timelag' / &
         ANTags(1289)%Label / 'col_145_flag_threshold' / &
         ANTags(1290)%Label / 'col_146_min_value' / &
         ANTags(1291)%Label / 'col_146_max_value' / &
         ANTags(1292)%Label / 'col_146_a_value' / &
         ANTags(1293)%Label / 'col_146_b_value' / &
         ANTags(1294)%Label / 'col_146_nom_timelag' / &
         ANTags(1295)%Label / 'col_146_min_timelag' / &
         ANTags(1296)%Label / 'col_146_max_timelag' / &
         ANTags(1297)%Label / 'col_146_flag_threshold' / &
         ANTags(1298)%Label / 'col_147_min_value' / &
         ANTags(1299)%Label / 'col_147_max_value' / &
         ANTags(1300)%Label / 'col_147_a_value' / &
         ANTags(1301)%Label / 'col_147_b_value' / &
         ANTags(1302)%Label / 'col_147_nom_timelag' / &
         ANTags(1303)%Label / 'col_147_min_timelag' / &
         ANTags(1304)%Label / 'col_147_max_timelag' / &
         ANTags(1305)%Label / 'col_147_flag_threshold' / &
         ANTags(1306)%Label / 'col_148_min_value' / &
         ANTags(1307)%Label / 'col_148_max_value' / &
         ANTags(1308)%Label / 'col_148_a_value' / &
         ANTags(1309)%Label / 'col_148_b_value' / &
         ANTags(1310)%Label / 'col_148_nom_timelag' / &
         ANTags(1311)%Label / 'col_148_min_timelag' / &
         ANTags(1312)%Label / 'col_148_max_timelag' / &
         ANTags(1313)%Label / 'col_148_flag_threshold' / &
         ANTags(1314)%Label / 'col_149_min_value' / &
         ANTags(1315)%Label / 'col_149_max_value' / &
         ANTags(1316)%Label / 'col_149_a_value' / &
         ANTags(1317)%Label / 'col_149_b_value' / &
         ANTags(1318)%Label / 'col_149_nom_timelag' / &
         ANTags(1319)%Label / 'col_149_min_timelag' / &
         ANTags(1320)%Label / 'col_149_max_timelag' / &
         ANTags(1321)%Label / 'col_149_flag_threshold' / &
         ANTags(1322)%Label / 'col_150_min_value' / &
         ANTags(1323)%Label / 'col_150_max_value' / &
         ANTags(1324)%Label / 'col_150_a_value' / &
         ANTags(1325)%Label / 'col_150_b_value' / &
         ANTags(1326)%Label / 'col_150_nom_timelag' / &
         ANTags(1327)%Label / 'col_150_min_timelag' / &
         ANTags(1328)%Label / 'col_150_max_timelag' / &
         ANTags(1329)%Label / 'col_150_flag_threshold' / &
         ANTags(1330)%Label / 'col_151_min_value' / &
         ANTags(1331)%Label / 'col_151_max_value' / &
         ANTags(1332)%Label / 'col_151_a_value' / &
         ANTags(1333)%Label / 'col_151_b_value' / &
         ANTags(1334)%Label / 'col_151_nom_timelag' / &
         ANTags(1335)%Label / 'col_151_min_timelag' / &
         ANTags(1336)%Label / 'col_151_max_timelag' / &
         ANTags(1337)%Label / 'col_151_flag_threshold' / &
         ANTags(1338)%Label / 'col_152_min_value' / &
         ANTags(1339)%Label / 'col_152_max_value' / &
         ANTags(1340)%Label / 'col_152_a_value' / &
         ANTags(1341)%Label / 'col_152_b_value' / &
         ANTags(1342)%Label / 'col_152_nom_timelag' / &
         ANTags(1343)%Label / 'col_152_min_timelag' / &
         ANTags(1344)%Label / 'col_152_max_timelag' / &
         ANTags(1345)%Label / 'col_152_flag_threshold' / &
         ANTags(1346)%Label / 'col_153_min_value' / &
         ANTags(1347)%Label / 'col_153_max_value' / &
         ANTags(1348)%Label / 'col_153_a_value' / &
         ANTags(1349)%Label / 'col_153_b_value' / &
         ANTags(1350)%Label / 'col_153_nom_timelag' / &
         ANTags(1351)%Label / 'col_153_min_timelag' / &
         ANTags(1352)%Label / 'col_153_max_timelag' / &
         ANTags(1353)%Label / 'col_153_flag_threshold' / &
         ANTags(1354)%Label / 'col_154_min_value' / &
         ANTags(1355)%Label / 'col_154_max_value' / &
         ANTags(1356)%Label / 'col_154_a_value' / &
         ANTags(1357)%Label / 'col_154_b_value' / &
         ANTags(1358)%Label / 'col_154_nom_timelag' / &
         ANTags(1359)%Label / 'col_154_min_timelag' / &
         ANTags(1360)%Label / 'col_154_max_timelag' / &
         ANTags(1361)%Label / 'col_154_flag_threshold' / &
         ANTags(1362)%Label / 'col_155_min_value' / &
         ANTags(1363)%Label / 'col_155_max_value' / &
         ANTags(1364)%Label / 'col_155_a_value' / &
         ANTags(1365)%Label / 'col_155_b_value' / &
         ANTags(1366)%Label / 'col_155_nom_timelag' / &
         ANTags(1367)%Label / 'col_155_min_timelag' / &
         ANTags(1368)%Label / 'col_155_max_timelag' / &
         ANTags(1369)%Label / 'col_155_flag_threshold' / &
         ANTags(1370)%Label / 'col_156_min_value' / &
         ANTags(1371)%Label / 'col_156_max_value' / &
         ANTags(1372)%Label / 'col_156_a_value' / &
         ANTags(1373)%Label / 'col_156_b_value' / &
         ANTags(1374)%Label / 'col_156_nom_timelag' / &
         ANTags(1375)%Label / 'col_156_min_timelag' / &
         ANTags(1376)%Label / 'col_156_max_timelag' / &
         ANTags(1377)%Label / 'col_156_flag_threshold' / &
         ANTags(1378)%Label / 'col_157_min_value' / &
         ANTags(1379)%Label / 'col_157_max_value' / &
         ANTags(1380)%Label / 'col_157_a_value' / &
         ANTags(1381)%Label / 'col_157_b_value' / &
         ANTags(1382)%Label / 'col_157_nom_timelag' / &
         ANTags(1383)%Label / 'col_157_min_timelag' / &
         ANTags(1384)%Label / 'col_157_max_timelag' / &
         ANTags(1385)%Label / 'col_157_flag_threshold' / &
         ANTags(1386)%Label / 'col_158_min_value' / &
         ANTags(1387)%Label / 'col_158_max_value' / &
         ANTags(1388)%Label / 'col_158_a_value' / &
         ANTags(1389)%Label / 'col_158_b_value' / &
         ANTags(1390)%Label / 'col_158_nom_timelag' / &
         ANTags(1391)%Label / 'col_158_min_timelag' / &
         ANTags(1392)%Label / 'col_158_max_timelag' / &
         ANTags(1393)%Label / 'col_158_flag_threshold' / &
         ANTags(1394)%Label / 'col_159_min_value' / &
         ANTags(1395)%Label / 'col_159_max_value' / &
         ANTags(1396)%Label / 'col_159_a_value' / &
         ANTags(1397)%Label / 'col_159_b_value' / &
         ANTags(1398)%Label / 'col_159_nom_timelag' / &
         ANTags(1399)%Label / 'col_159_min_timelag' / &
         ANTags(1400)%Label / 'col_159_max_timelag' /
    data ANTags(1401)%Label / 'col_159_flag_threshold' / &
         ANTags(1402)%Label / 'col_160_min_value' / &
         ANTags(1403)%Label / 'col_160_max_value' / &
         ANTags(1404)%Label / 'col_160_a_value' / &
         ANTags(1405)%Label / 'col_160_b_value' / &
         ANTags(1406)%Label / 'col_160_nom_timelag' / &
         ANTags(1407)%Label / 'col_160_min_timelag' / &
         ANTags(1408)%Label / 'col_160_max_timelag' / &
         ANTags(1409)%Label / 'col_160_flag_threshold' / &
         ANTags(1410)%Label / 'col_161_min_value' / &
         ANTags(1411)%Label / 'col_161_max_value' / &
         ANTags(1412)%Label / 'col_161_a_value' / &
         ANTags(1413)%Label / 'col_161_b_value' / &
         ANTags(1414)%Label / 'col_161_nom_timelag' / &
         ANTags(1415)%Label / 'col_161_min_timelag' / &
         ANTags(1416)%Label / 'col_161_max_timelag' / &
         ANTags(1417)%Label / 'col_161_flag_threshold' / &
         ANTags(1418)%Label / 'col_162_min_value' / &
         ANTags(1419)%Label / 'col_162_max_value' / &
         ANTags(1420)%Label / 'col_162_a_value' / &
         ANTags(1421)%Label / 'col_162_b_value' / &
         ANTags(1422)%Label / 'col_162_nom_timelag' / &
         ANTags(1423)%Label / 'col_162_min_timelag' / &
         ANTags(1424)%Label / 'col_162_max_timelag' / &
         ANTags(1425)%Label / 'col_162_flag_threshold' / &
         ANTags(1426)%Label / 'col_163_min_value' / &
         ANTags(1427)%Label / 'col_163_max_value' / &
         ANTags(1428)%Label / 'col_163_a_value' / &
         ANTags(1429)%Label / 'col_163_b_value' / &
         ANTags(1430)%Label / 'col_163_nom_timelag' / &
         ANTags(1431)%Label / 'col_163_min_timelag' / &
         ANTags(1432)%Label / 'col_163_max_timelag' / &
         ANTags(1433)%Label / 'col_163_flag_threshold' / &
         ANTags(1434)%Label / 'col_164_min_value' / &
         ANTags(1435)%Label / 'col_164_max_value' / &
         ANTags(1436)%Label / 'col_164_a_value' / &
         ANTags(1437)%Label / 'col_164_b_value' / &
         ANTags(1438)%Label / 'col_164_nom_timelag' / &
         ANTags(1439)%Label / 'col_164_min_timelag' / &
         ANTags(1440)%Label / 'col_164_max_timelag' / &
         ANTags(1441)%Label / 'col_164_flag_threshold' / &
         ANTags(1442)%Label / 'col_165_min_value' / &
         ANTags(1443)%Label / 'col_165_max_value' / &
         ANTags(1444)%Label / 'col_165_a_value' / &
         ANTags(1445)%Label / 'col_165_b_value' / &
         ANTags(1446)%Label / 'col_165_nom_timelag' / &
         ANTags(1447)%Label / 'col_165_min_timelag' / &
         ANTags(1448)%Label / 'col_165_max_timelag' / &
         ANTags(1449)%Label / 'col_165_flag_threshold' / &
         ANTags(1450)%Label / 'col_166_min_value' / &
         ANTags(1451)%Label / 'col_166_max_value' / &
         ANTags(1452)%Label / 'col_166_a_value' / &
         ANTags(1453)%Label / 'col_166_b_value' / &
         ANTags(1454)%Label / 'col_166_nom_timelag' / &
         ANTags(1455)%Label / 'col_166_min_timelag' / &
         ANTags(1456)%Label / 'col_166_max_timelag' / &
         ANTags(1457)%Label / 'col_166_flag_threshold' / &
         ANTags(1458)%Label / 'col_167_min_value' / &
         ANTags(1459)%Label / 'col_167_max_value' / &
         ANTags(1460)%Label / 'col_167_a_value' / &
         ANTags(1461)%Label / 'col_167_b_value' / &
         ANTags(1462)%Label / 'col_167_nom_timelag' / &
         ANTags(1463)%Label / 'col_167_min_timelag' / &
         ANTags(1464)%Label / 'col_167_max_timelag' / &
         ANTags(1465)%Label / 'col_167_flag_threshold' / &
         ANTags(1466)%Label / 'col_168_min_value' / &
         ANTags(1467)%Label / 'col_168_max_value' / &
         ANTags(1468)%Label / 'col_168_a_value' / &
         ANTags(1469)%Label / 'col_168_b_value' / &
         ANTags(1470)%Label / 'col_168_nom_timelag' / &
         ANTags(1471)%Label / 'col_168_min_timelag' / &
         ANTags(1472)%Label / 'col_168_max_timelag' / &
         ANTags(1473)%Label / 'col_168_flag_threshold' / &
         ANTags(1474)%Label / 'col_169_min_value' / &
         ANTags(1475)%Label / 'col_169_max_value' / &
         ANTags(1476)%Label / 'col_169_a_value' / &
         ANTags(1477)%Label / 'col_169_b_value' / &
         ANTags(1478)%Label / 'col_169_nom_timelag' / &
         ANTags(1479)%Label / 'col_169_min_timelag' / &
         ANTags(1480)%Label / 'col_169_max_timelag' / &
         ANTags(1481)%Label / 'col_169_flag_threshold' / &
         ANTags(1482)%Label / 'col_170_min_value' / &
         ANTags(1483)%Label / 'col_170_max_value' / &
         ANTags(1484)%Label / 'col_170_a_value' / &
         ANTags(1485)%Label / 'col_170_b_value' / &
         ANTags(1486)%Label / 'col_170_nom_timelag' / &
         ANTags(1487)%Label / 'col_170_min_timelag' / &
         ANTags(1488)%Label / 'col_170_max_timelag' / &
         ANTags(1489)%Label / 'col_170_flag_threshold' / &
         ANTags(1490)%Label / 'col_171_min_value' / &
         ANTags(1491)%Label / 'col_171_max_value' / &
         ANTags(1492)%Label / 'col_171_a_value' / &
         ANTags(1493)%Label / 'col_171_b_value' / &
         ANTags(1494)%Label / 'col_171_nom_timelag' / &
         ANTags(1495)%Label / 'col_171_min_timelag' / &
         ANTags(1496)%Label / 'col_171_max_timelag' / &
         ANTags(1497)%Label / 'col_171_flag_threshold' / &
         ANTags(1498)%Label / 'col_172_min_value' / &
         ANTags(1499)%Label / 'col_172_max_value' / &
         ANTags(1500)%Label / 'col_172_a_value' / &
         ANTags(1501)%Label / 'col_172_b_value' / &
         ANTags(1502)%Label / 'col_172_nom_timelag' / &
         ANTags(1503)%Label / 'col_172_min_timelag' / &
         ANTags(1504)%Label / 'col_172_max_timelag' / &
         ANTags(1505)%Label / 'col_172_flag_threshold' / &
         ANTags(1506)%Label / 'col_173_min_value' / &
         ANTags(1507)%Label / 'col_173_max_value' / &
         ANTags(1508)%Label / 'col_173_a_value' / &
         ANTags(1509)%Label / 'col_173_b_value' / &
         ANTags(1510)%Label / 'col_173_nom_timelag' / &
         ANTags(1511)%Label / 'col_173_min_timelag' / &
         ANTags(1512)%Label / 'col_173_max_timelag' / &
         ANTags(1513)%Label / 'col_173_flag_threshold' / &
         ANTags(1514)%Label / 'col_174_min_value' / &
         ANTags(1515)%Label / 'col_174_max_value' / &
         ANTags(1516)%Label / 'col_174_a_value' / &
         ANTags(1517)%Label / 'col_174_b_value' / &
         ANTags(1518)%Label / 'col_174_nom_timelag' / &
         ANTags(1519)%Label / 'col_174_min_timelag' / &
         ANTags(1520)%Label / 'col_174_max_timelag' / &
         ANTags(1521)%Label / 'col_174_flag_threshold' / &
         ANTags(1522)%Label / 'col_175_min_value' / &
         ANTags(1523)%Label / 'col_175_max_value' / &
         ANTags(1524)%Label / 'col_175_a_value' / &
         ANTags(1525)%Label / 'col_175_b_value' / &
         ANTags(1526)%Label / 'col_175_nom_timelag' / &
         ANTags(1527)%Label / 'col_175_min_timelag' / &
         ANTags(1528)%Label / 'col_175_max_timelag' / &
         ANTags(1529)%Label / 'col_175_flag_threshold' / &
         ANTags(1530)%Label / 'col_176_min_value' / &
         ANTags(1531)%Label / 'col_176_max_value' / &
         ANTags(1532)%Label / 'col_176_a_value' / &
         ANTags(1533)%Label / 'col_176_b_value' / &
         ANTags(1534)%Label / 'col_176_nom_timelag' / &
         ANTags(1535)%Label / 'col_176_min_timelag' / &
         ANTags(1536)%Label / 'col_176_max_timelag' / &
         ANTags(1537)%Label / 'col_176_flag_threshold' / &
         ANTags(1538)%Label / 'col_177_min_value' / &
         ANTags(1539)%Label / 'col_177_max_value' / &
         ANTags(1540)%Label / 'col_177_a_value' / &
         ANTags(1541)%Label / 'col_177_b_value' / &
         ANTags(1542)%Label / 'col_177_nom_timelag' / &
         ANTags(1543)%Label / 'col_177_min_timelag' / &
         ANTags(1544)%Label / 'col_177_max_timelag' / &
         ANTags(1545)%Label / 'col_177_flag_threshold' / &
         ANTags(1546)%Label / 'col_178_min_value' / &
         ANTags(1547)%Label / 'col_178_max_value' / &
         ANTags(1548)%Label / 'col_178_a_value' / &
         ANTags(1549)%Label / 'col_178_b_value' / &
         ANTags(1550)%Label / 'col_178_nom_timelag' / &
         ANTags(1551)%Label / 'col_178_min_timelag' / &
         ANTags(1552)%Label / 'col_178_max_timelag' / &
         ANTags(1553)%Label / 'col_178_flag_threshold' / &
         ANTags(1554)%Label / 'col_179_min_value' / &
         ANTags(1555)%Label / 'col_179_max_value' / &
         ANTags(1556)%Label / 'col_179_a_value' / &
         ANTags(1557)%Label / 'col_179_b_value' / &
         ANTags(1558)%Label / 'col_179_nom_timelag' / &
         ANTags(1559)%Label / 'col_179_min_timelag' / &
         ANTags(1560)%Label / 'col_179_max_timelag' / &
         ANTags(1561)%Label / 'col_179_flag_threshold' / &
         ANTags(1562)%Label / 'col_180_min_value' / &
         ANTags(1563)%Label / 'col_180_max_value' / &
         ANTags(1564)%Label / 'col_180_a_value' / &
         ANTags(1565)%Label / 'col_180_b_value' / &
         ANTags(1566)%Label / 'col_180_nom_timelag' / &
         ANTags(1567)%Label / 'col_180_min_timelag' / &
         ANTags(1568)%Label / 'col_180_max_timelag' / &
         ANTags(1569)%Label / 'col_180_flag_threshold' / &
         ANTags(1570)%Label / 'col_181_min_value' / &
         ANTags(1571)%Label / 'col_181_max_value' / &
         ANTags(1572)%Label / 'col_181_a_value' / &
         ANTags(1573)%Label / 'col_181_b_value' / &
         ANTags(1574)%Label / 'col_181_nom_timelag' / &
         ANTags(1575)%Label / 'col_181_min_timelag' / &
         ANTags(1576)%Label / 'col_181_max_timelag' / &
         ANTags(1577)%Label / 'col_181_flag_threshold' / &
         ANTags(1578)%Label / 'col_182_min_value' / &
         ANTags(1579)%Label / 'col_182_max_value' / &
         ANTags(1580)%Label / 'col_182_a_value' / &
         ANTags(1581)%Label / 'col_182_b_value' / &
         ANTags(1582)%Label / 'col_182_nom_timelag' / &
         ANTags(1583)%Label / 'col_182_min_timelag' / &
         ANTags(1584)%Label / 'col_182_max_timelag' / &
         ANTags(1585)%Label / 'col_182_flag_threshold' / &
         ANTags(1586)%Label / 'col_183_min_value' / &
         ANTags(1587)%Label / 'col_183_max_value' / &
         ANTags(1588)%Label / 'col_183_a_value' / &
         ANTags(1589)%Label / 'col_183_b_value' / &
         ANTags(1590)%Label / 'col_183_nom_timelag' / &
         ANTags(1591)%Label / 'col_183_min_timelag' / &
         ANTags(1592)%Label / 'col_183_max_timelag' / &
         ANTags(1593)%Label / 'col_183_flag_threshold' / &
         ANTags(1594)%Label / 'col_184_min_value' / &
         ANTags(1595)%Label / 'col_184_max_value' / &
         ANTags(1596)%Label / 'col_184_a_value' / &
         ANTags(1597)%Label / 'col_184_b_value' / &
         ANTags(1598)%Label / 'col_184_nom_timelag' / &
         ANTags(1599)%Label / 'col_184_min_timelag' / &
         ANTags(1600)%Label / 'col_184_max_timelag' /
    data ANTags(1601)%Label / 'col_184_flag_threshold' / &
         ANTags(1602)%Label / 'col_185_min_value' / &
         ANTags(1603)%Label / 'col_185_max_value' / &
         ANTags(1604)%Label / 'col_185_a_value' / &
         ANTags(1605)%Label / 'col_185_b_value' / &
         ANTags(1606)%Label / 'col_185_nom_timelag' / &
         ANTags(1607)%Label / 'col_185_min_timelag' / &
         ANTags(1608)%Label / 'col_185_max_timelag' / &
         ANTags(1609)%Label / 'col_185_flag_threshold' / &
         ANTags(1610)%Label / 'col_186_min_value' / &
         ANTags(1611)%Label / 'col_186_max_value' / &
         ANTags(1612)%Label / 'col_186_a_value' / &
         ANTags(1613)%Label / 'col_186_b_value' / &
         ANTags(1614)%Label / 'col_186_nom_timelag' / &
         ANTags(1615)%Label / 'col_186_min_timelag' / &
         ANTags(1616)%Label / 'col_186_max_timelag' / &
         ANTags(1617)%Label / 'col_186_flag_threshold' / &
         ANTags(1618)%Label / 'col_187_min_value' / &
         ANTags(1619)%Label / 'col_187_max_value' / &
         ANTags(1620)%Label / 'col_187_a_value' / &
         ANTags(1621)%Label / 'col_187_b_value' / &
         ANTags(1622)%Label / 'col_187_nom_timelag' / &
         ANTags(1623)%Label / 'col_187_min_timelag' / &
         ANTags(1624)%Label / 'col_187_max_timelag' / &
         ANTags(1625)%Label / 'col_187_flag_threshold' / &
         ANTags(1626)%Label / 'col_188_min_value' / &
         ANTags(1627)%Label / 'col_188_max_value' / &
         ANTags(1628)%Label / 'col_188_a_value' / &
         ANTags(1629)%Label / 'col_188_b_value' / &
         ANTags(1630)%Label / 'col_188_nom_timelag' / &
         ANTags(1631)%Label / 'col_188_min_timelag' / &
         ANTags(1632)%Label / 'col_188_max_timelag' / &
         ANTags(1633)%Label / 'col_188_flag_threshold' / &
         ANTags(1634)%Label / 'col_189_min_value' / &
         ANTags(1635)%Label / 'col_189_max_value' / &
         ANTags(1636)%Label / 'col_189_a_value' / &
         ANTags(1637)%Label / 'col_189_b_value' / &
         ANTags(1638)%Label / 'col_189_nom_timelag' / &
         ANTags(1639)%Label / 'col_189_min_timelag' / &
         ANTags(1640)%Label / 'col_189_max_timelag' / &
         ANTags(1641)%Label / 'col_189_flag_threshold' / &
         ANTags(1642)%Label / 'col_190_min_value' / &
         ANTags(1643)%Label / 'col_190_max_value' / &
         ANTags(1644)%Label / 'col_190_a_value' / &
         ANTags(1645)%Label / 'col_190_b_value' / &
         ANTags(1646)%Label / 'col_190_nom_timelag' / &
         ANTags(1647)%Label / 'col_190_min_timelag' / &
         ANTags(1648)%Label / 'col_190_max_timelag' / &
         ANTags(1649)%Label / 'col_190_flag_threshold' / &
         ANTags(1650)%Label / 'col_191_min_value' / &
         ANTags(1651)%Label / 'col_191_max_value' / &
         ANTags(1652)%Label / 'col_191_a_value' / &
         ANTags(1653)%Label / 'col_191_b_value' / &
         ANTags(1654)%Label / 'col_191_nom_timelag' / &
         ANTags(1655)%Label / 'col_191_min_timelag' / &
         ANTags(1656)%Label / 'col_191_max_timelag' / &
         ANTags(1657)%Label / 'col_191_flag_threshold' / &
         ANTags(1658)%Label / 'col_192_min_value' / &
         ANTags(1659)%Label / 'col_192_max_value' / &
         ANTags(1660)%Label / 'col_192_a_value' / &
         ANTags(1661)%Label / 'col_192_b_value' / &
         ANTags(1662)%Label / 'col_192_nom_timelag' / &
         ANTags(1663)%Label / 'col_192_min_timelag' / &
         ANTags(1664)%Label / 'col_192_max_timelag' / &
         ANTags(1665)%Label / 'col_192_flag_threshold' / &
         ANTags(1666)%Label / 'col_193_min_value' / &
         ANTags(1667)%Label / 'col_193_max_value' / &
         ANTags(1668)%Label / 'col_193_a_value' / &
         ANTags(1669)%Label / 'col_193_b_value' / &
         ANTags(1670)%Label / 'col_193_nom_timelag' / &
         ANTags(1671)%Label / 'col_193_min_timelag' / &
         ANTags(1672)%Label / 'col_193_max_timelag' / &
         ANTags(1673)%Label / 'col_193_flag_threshold' / &
         ANTags(1674)%Label / 'col_194_min_value' / &
         ANTags(1675)%Label / 'col_194_max_value' / &
         ANTags(1676)%Label / 'col_194_a_value' / &
         ANTags(1677)%Label / 'col_194_b_value' / &
         ANTags(1678)%Label / 'col_194_nom_timelag' / &
         ANTags(1679)%Label / 'col_194_min_timelag' / &
         ANTags(1680)%Label / 'col_194_max_timelag' / &
         ANTags(1681)%Label / 'col_194_flag_threshold' / &
         ANTags(1682)%Label / 'col_195_min_value' / &
         ANTags(1683)%Label / 'col_195_max_value' / &
         ANTags(1684)%Label / 'col_195_a_value' / &
         ANTags(1685)%Label / 'col_195_b_value' / &
         ANTags(1686)%Label / 'col_195_nom_timelag' / &
         ANTags(1687)%Label / 'col_195_min_timelag' / &
         ANTags(1688)%Label / 'col_195_max_timelag' / &
         ANTags(1689)%Label / 'col_195_flag_threshold' / &
         ANTags(1690)%Label / 'col_196_min_value' / &
         ANTags(1691)%Label / 'col_196_max_value' / &
         ANTags(1692)%Label / 'col_196_a_value' / &
         ANTags(1693)%Label / 'col_196_b_value' / &
         ANTags(1694)%Label / 'col_196_nom_timelag' / &
         ANTags(1695)%Label / 'col_196_min_timelag' / &
         ANTags(1696)%Label / 'col_196_max_timelag' / &
         ANTags(1697)%Label / 'col_196_flag_threshold' / &
         ANTags(1698)%Label / 'col_197_min_value' / &
         ANTags(1699)%Label / 'col_197_max_value' / &
         ANTags(1700)%Label / 'col_197_a_value' / &
         ANTags(1701)%Label / 'col_197_b_value' / &
         ANTags(1702)%Label / 'col_197_nom_timelag' / &
         ANTags(1703)%Label / 'col_197_min_timelag' / &
         ANTags(1704)%Label / 'col_197_max_timelag' / &
         ANTags(1705)%Label / 'col_197_flag_threshold' / &
         ANTags(1706)%Label / 'col_198_min_value' / &
         ANTags(1707)%Label / 'col_198_max_value' / &
         ANTags(1708)%Label / 'col_198_a_value' / &
         ANTags(1709)%Label / 'col_198_b_value' / &
         ANTags(1710)%Label / 'col_198_nom_timelag' / &
         ANTags(1711)%Label / 'col_198_min_timelag' / &
         ANTags(1712)%Label / 'col_198_max_timelag' / &
         ANTags(1713)%Label / 'col_198_flag_threshold' / &
         ANTags(1714)%Label / 'col_199_min_value' / &
         ANTags(1715)%Label / 'col_199_max_value' / &
         ANTags(1716)%Label / 'col_199_a_value' / &
         ANTags(1717)%Label / 'col_199_b_value' / &
         ANTags(1718)%Label / 'col_199_nom_timelag' / &
         ANTags(1719)%Label / 'col_199_min_timelag' / &
         ANTags(1720)%Label / 'col_199_max_timelag' / &
         ANTags(1721)%Label / 'col_199_flag_threshold' / &
         ANTags(1722)%Label / 'col_200_min_value' / &
         ANTags(1723)%Label / 'col_200_max_value' / &
         ANTags(1724)%Label / 'col_200_a_value' / &
         ANTags(1725)%Label / 'col_200_b_value' / &
         ANTags(1726)%Label / 'col_200_nom_timelag' / &
         ANTags(1727)%Label / 'col_200_min_timelag' / &
         ANTags(1728)%Label / 'col_200_max_timelag' / &
         ANTags(1729)%Label / 'col_200_flag_threshold' /
