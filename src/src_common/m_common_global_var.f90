...
module m_common_global_var
    ...
    character(7), parameter  :: EddyFlow_FilePadding    = 'EddyFlow'
    character(11), parameter :: RP_FilePadding = 'EddyFlow-rp_'
    character(12), parameter :: FX_FilePadding = 'EddyFlow-fcc_'
    ...
    character(24), parameter :: SubDirBinCospectra      = 'EddyFlow_binned_cospectra'
    character(22), parameter :: SubDirCospectra         = 'EddyFlow_full_cospectra'
