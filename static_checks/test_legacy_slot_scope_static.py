...
ALLOWED = {
    ...
    "src/src_fcc/fluxes1.f90": 2,
    "src/src_fcc/init_out_files.f90": 30,
    "src/src_fcc/output_spectral_assessment_results.f90": 8,
    "src/src_fcc/read_ini_fcc.f90": 24,
    ...
    "src/src_rp/adjust_timelag_opt_settings.f90": 1,
